...
<template>
  <aside class="sidenav">
    <div class="sidenav__main">
      ...
      <nav>
        <router-link class="sidenav__link" :class="{ active: currentRoute === '/' }" to="/"
          >Home</router-link
        >
        <router-link
          class="sidenav__link"
          ...
          to="/schedule"
          >Session Schedule</router-link
        >
        <router-link
          class="sidenav__link"
          :class="{ active: currentRoute === '/sessions' }"
          to="/sessions"
          >Registered Sessions</router-link
        >
        <router-link
          v-if="userRole === 'ADMIN'"
          class="sidenav__link"
    ...
    <router-link @click.native="handleLogout" class="sidenav__link sidenav__logout" to="/login"
      >Logout</router-link
    >
  </aside>
</template>
